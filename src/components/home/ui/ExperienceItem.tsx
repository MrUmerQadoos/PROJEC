  ...
  return (
    <CardBox classNames="p-4 items-center text-center bg-[var(--textColor10)] group min-h-80">
      <Column classNames="items-center justify-between w-full h-full gap-12">
        ...
        <div
          className="flex flex-row relative gap-1 items-center justify-center px-2 py-0.5 border border-[var(--textColor)] text-[var(--textColor)] rounded-[var(--borderRadius)]"
        >
